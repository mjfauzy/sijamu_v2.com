...
$folder = "../files/uploads/disahkan/";

$status = "Telah Disahkan";

$tanggal_edit = date('d-m-Y, H:i:s');
$tanggal_approved = date('d-m-Y');
...
$insert_autentikasi_dokumen = mysqli_query($connect,"UPDATE tbl_rek_autentikasi_dokumen SET disahkan_oleh='$id_user',tanggal_disahkan='$tanggal_approved' WHERE no_dokumen='$no_dokumen'");
