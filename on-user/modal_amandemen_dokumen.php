...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Amandemen Dokumen</h4>
        </div>

        <div class="modal-body">
          <form action="proses_amandemen_dokumen.php" name="modal_popup" enctype="multipart/form-data" method="POST">
