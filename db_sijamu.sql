...
--
-- Host: 127.0.0.1
-- Generation Time: 22 Jun 2017 pada 11.38
...
CREATE TABLE `tbl_dokumen` (
  ...
  `status` enum('Draf','Telah Diperiksa','Telah Disahkan','Terkendali','Tergandakan','Telah Dipublikasi','Tidak Berlaku','Telah Dihapus') NOT NULL,
...
(1, '22-06-2017', 'SOP.02', 'SOP 001.002/KN 09 06/SBM', 'SOP Pengendalian Dokumen', 'Dokumen SOP Pengendalian Dokumen', 2015, 'SBM.5', 'Telah Dipublikasi', '64842-93828-SOP 001 02 SMT PENGENDALIAN DOKUMEN.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 360744, '11', '22-06-2017, 10:34:34');
...
--
-- Struktur dari tabel `tbl_rek_bukti`
--

CREATE TABLE `tbl_rek_bukti` (
  `id_bukti` int(11) NOT NULL,
  `kode_dokumen` varchar(30) NOT NULL,
  `jenis_bukti` enum('Penerimaan Salinan','Penarikan') NOT NULL,
...
--
-- Struktur dari tabel `tbl_rek_daftar_dokumen_dimusnahkan`
--

CREATE TABLE `tbl_rek_daftar_dokumen_dimusnahkan` (
  `id_daftar` int(11) NOT NULL,
  `kode_dokumen` varchar(30) NOT NULL,
  `diskripsi_dokumen` text NOT NULL,
...
(1, 'Drs. Gunawan, M.Sc', 'Kepala', 'Eselon II', 'IV/c', 'SBM.0', '195708281983031004', '98d2bd4ace193c01650928de90bd6d6c', 'user', '22-06-2017, 10:33:52'),
(2, 'Aswan Edysyah Putra, S.IP.', 'Kepala', 'Eselon III', 'IV/b', 'SBM.1', '196610311990031001', '0a21f3e15f8c78a9c4e9df1a64cae6a1', 'user', '22-06-2017, 10:30:44'),
(3, 'Rd. Nenny Gunawati', 'Kepala', 'Eselon IV', 'III/d', 'SBM.1.1', '196511041986032004', '4c9257c2f1ae5bf58b207818d6f5cb3e', 'user', '20-06-2017, 08:59:31'),
...
(8, 'Sairun, ST.', 'Kepala', 'Eselon III', 'III/d', 'SBM.4', '196609271986021001', 'f065247257b8d4064e2469e2e5cdc6ac', 'user', '19-06-2017, 15:48:14'),
...
(11, 'Irfan Hafid, A.Md.', 'Kepala', 'Eselon IV', 'III/c', 'SBM.5', '197010181991121001', '128a97ca14c90e9d80c80f56bc8beb7b', 'admin', '22-06-2017, 10:19:25'),
(14, 'Administrator', 'Staf', '-', 'I/a', 'SBM.5', 'admin', '0192023a7bbd73250516f069df18b500', 'admin', '21-06-2017, 13:02:08'),
...
(18, 'Bu Rina', 'Staf', '-', 'III/c', 'SBM.5', '12345678', '25d55ad283aa400af464c76d713c07ad', 'admin', '22-06-2017, 10:35:15'),
...
(23, 'Joni', 'Staf', '-', 'III/d', 'SBM.1.3', 'joni', '1c0ac25b077a885dc53d91b05b14544e', 'user', '17-06-2017, 08:09:03');
...
--
-- Indexes for table `tbl_rek_bukti`
--
ALTER TABLE `tbl_rek_bukti`
  ADD PRIMARY KEY (`id_bukti`);

--
-- Indexes for table `tbl_rek_daftar_dokumen_dimusnahkan`
--
ALTER TABLE `tbl_rek_daftar_dokumen_dimusnahkan`
...
--
ALTER TABLE `tbl_rek_autentikasi_dokumen`
  MODIFY `id_autentikasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_rek_bukti`
--
ALTER TABLE `tbl_rek_bukti`
  MODIFY `id_bukti` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tbl_rek_daftar_dokumen_dimusnahkan`
--
ALTER TABLE `tbl_rek_daftar_dokumen_dimusnahkan`
...
--
ALTER TABLE `tbl_rek_daftar_induk_dokumen`
  MODIFY `id_daftar_induk` int(32) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
